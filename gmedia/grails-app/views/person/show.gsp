            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="person.albums.label" default="Albums" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="person.styles.label" default="Styles" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${personInstance.styles}" var="s">
